function colorList = read_pes_nlayer_color(num_colors)
% colorList = read_pes_nlayer_color(num_colors)
%   This function returns a cell array of RGB colors that consistently color 
%   the material layers for the N-Layer stack model simulations.
%
%   IN: 
...
for i = 1:num_colors
    if i == num_colors;     colorList{i} = bulk_color;
