...
if plot_results == 1
    ...
    text(0.02, 0.90, sprintf("NIST(2005)"),...
    ...
    if ele_indx < 14;       axis([5, 1e6, -5, 20]);
    elseif ele_indx < 29;   axis([5, 1e6, -20, 40]);
    else;                   axis([5, 1e6, -40, 100]);
    end
    ...
    if ele_indx < 14;   axis([5, 1e6, 1e-9, 1e3]);
    else;               axis([5, 1e6, 1e-5, 1e3]);
    end
end
end