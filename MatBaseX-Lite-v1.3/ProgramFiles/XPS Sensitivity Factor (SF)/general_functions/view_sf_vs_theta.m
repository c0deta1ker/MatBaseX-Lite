function fig = view_sf_vs_theta(element, corelevel)
% fig = view_sf_vs_theta(element, corelevel)
...
SF_SX = {}; SF_HX = {};
for i = 1:nCL
    SF_SX{i}    = calc_sf(element, element, ATOM_CL(i), hv, theta, phi, P, 'T2018', 'jtp');
    SF_HX{i}    = calc_sf(element, element, ATOM_CL(i), hv, theta, phi, P, 'C2022', 'jtp');
end
