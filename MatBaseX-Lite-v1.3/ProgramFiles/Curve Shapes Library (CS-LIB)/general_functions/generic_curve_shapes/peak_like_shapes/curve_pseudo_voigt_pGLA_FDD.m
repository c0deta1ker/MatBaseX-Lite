function y = curve_pseudo_voigt_pGLA_FDD(x, center, amplitude, width, mixratio, asymmetry, fdd_center, fdd_temperature, fdd_width)
% y = curve_pseudo_voigt_pGLA_FDD(x, center, amplitude, width, mixratio, asymmetry, fdd_center, fdd_temperature, fdd_width)
...
int_pGLA  	= curve_pseudo_voigt_pGLA(x, center, amplitude, width, mixratio, asymmetry);
