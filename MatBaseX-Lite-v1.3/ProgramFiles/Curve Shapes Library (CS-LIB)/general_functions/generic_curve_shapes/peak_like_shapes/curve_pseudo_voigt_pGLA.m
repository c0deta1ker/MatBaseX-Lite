function y = curve_pseudo_voigt_pGLA(x, center, amplitude, width, mixratio, asymmetry)
% y = curve_pseudo_voigt_pGLA(x, center, amplitude, width, mixratio, asymmetry)
...
int_pGL     = curve_pseudo_voigt_pGL(x, center, amplitude, width, mixratio);
