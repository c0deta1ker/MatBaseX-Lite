function y = curve_step_rhs_gauss_trunc(x, center, amplitude, fwhm, cutoff)
% y = curve_step_rhs_gauss_trunc(x, center, amplitude, fwhm, cutoff)
...
y = curve_step_rhs_gauss(x, center, amplitude, fwhm);
