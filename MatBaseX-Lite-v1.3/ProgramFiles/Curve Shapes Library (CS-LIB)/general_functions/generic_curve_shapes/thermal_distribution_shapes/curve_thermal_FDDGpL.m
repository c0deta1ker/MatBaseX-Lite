function y = curve_thermal_FDDGpL(x, center, temperature, width, linear_slope, linear_intercept, constant_bgrnd)
% y = curve_thermal_FDDGpL(x, center, temperature, width, linear_slope, linear_intercept, constant_bgrnd)
