function y = curve_tophat_lhs_gauss_trunc(x, center, amplitude, width, fwhm, cutoff)
% y = curve_tophat_lhs_gauss_trunc(x, center, amplitude, width, fwhm, cutoff)
...
y = curve_tophat_lhs_gauss(x, center, amplitude, width, fwhm);
