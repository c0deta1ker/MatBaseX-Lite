function [roi_xdat, roi_ydat, roi_bgrnd] = pes_bgrnd_1tougaard(xdat, ydat, LHS, RHS, Win, C)
% [roi_xdat, roi_ydat, roi_bgrnd] = pes_bgrnd_1tougaard(xdat, ydat, LHS, RHS, Win, C)
...
while cnvgnce > 1e-12
    ...
    if data_parity == 1
        ...
        for i = 1:nRows-1
            ...
            Fi      = (roi_ydat(end-i:end)) .* dEi ./ (C + dEi.^2).^2;
