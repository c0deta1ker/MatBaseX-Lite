function [roi_xdat, roi_ydat, roi_bgrnd] = pes_bgrnd_shirley_smart(xdat, ydat, LHS, RHS, Win)
% [roi_xdat, roi_ydat, roi_bgrnd] = pes_bgrnd_shirley_smart(xdat, ydat, LHS, RHS, Win)
