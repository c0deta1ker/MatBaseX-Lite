function [roi_xdat, roi_ydat, roi_bgrnd] = pes_bgrnd_shirley_offset(xdat, ydat, LHS, RHS, Win, lambda, delta)
% [roi_xdat, roi_ydat, roi_bgrnd] = pes_bgrnd_shirley_offset(xdat, ydat, LHS, RHS, Win, lambda, delta)
...
[~, ~, roi_bgrnd_lin]   = pes_bgrnd_linear(xdat, ydat, LHS, RHS, Win);
[~, ~, roi_bgrnd_shrly]	= pes_bgrnd_shirley(xdat + delta, ydat, LHS, RHS, Win);
