function [roi_xdat, roi_ydat, roi_bgrnd] = pes_bgrnd_step_FDDGpL(xdat, ydat, LHS, RHS, Win, fdd_ef, fdd_T, fdd_fwhm)
% [roi_xdat, roi_ydat, roi_bgrnd] = pes_bgrnd_step_FDDGpL(xdat, ydat, LHS, RHS, Win, fdd_ef, fdd_T, fdd_fwhm)
...
fermi_fit = fittype(@(a, b, c, x) curve_thermal_FDDGpL(x, fdd_ef, fdd_T, fdd_fwhm, a, b, c));
...
roi_bgrnd           = curve_thermal_FDDGpL(roi_xdat, fdd_ef, fdd_T, fdd_fwhm, fit1para(1), fit1para(2), fit1para(3));
